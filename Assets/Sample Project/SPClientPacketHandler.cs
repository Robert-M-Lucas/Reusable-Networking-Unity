...
{
    public Dictionary<int, Tuple<double, double, double>> PlayerPos = new Dictionary<int, Tuple<double, double, double>>();
    ...
    public void PositionUpdate(Packet packet) {
        ...
        PlayerPos[positionPacket.PlayerID] = new Tuple<double, double, double>(positionPacket.x, positionPacket.y, positionPacket.z);
    }
}